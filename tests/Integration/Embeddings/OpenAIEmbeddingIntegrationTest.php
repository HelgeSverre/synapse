...
final class OpenAIEmbeddingIntegrationTest extends IntegrationTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->provider = new OpenAIEmbeddingProvider($transport, (string) getenv('OPENAI_API_KEY'));
    }
    ...
    {
        $response1 = $this->provider->embed('I love programming', 'text-embedding-3-small');
        $response2 = $this->provider->embed('I enjoy coding', 'text-embedding-3-small');
        $response3 = $this->provider->embed('The weather is nice today', 'text-embedding-3-small');
        ...
        $this->assertGreaterThan(0.7, $sim12, 'Similar texts should have high similarity');
    }
