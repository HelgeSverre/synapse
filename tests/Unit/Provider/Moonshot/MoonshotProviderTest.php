...
namespace HelgeSverre\Synapse\Tests\Unit\Provider\Moonshot;
...
final class MoonshotProviderTest extends TestCase
{
    ...
    public function test_generate_calls_correct_url(): void
    {
        ...
        $provider = new MoonshotProvider($transport, 'test-api-key');
        ...
        $this->assertSame('https://api.moonshot.ai/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_sets_authorization_header(): void
    {
        ...
        $this->assertSame('Bearer test-api-key', $transport->capturedHeaders['Authorization']);
    ...
    public function test_generate_passes_model_in_body(): void
    {
        ...
        $this->assertSame('moonshot-v1-32k', $transport->capturedBody['model']);
    }
    ...
    public function test_get_name_returns_moonshot(): void
    {
        $transport = $this->createMockTransport([]);
        $provider = new MoonshotProvider($transport, 'test-api-key');

        $this->assertSame('moonshot', $provider->getName());
    }
    ...
    public function test_custom_base_url_is_used(): void
    {
        ...
        $provider = new MoonshotProvider(
            $transport,
            'test-api-key',
            'https://custom.moonshot.example.com/v1',
        );
        ...
        $this->assertSame('https://custom.moonshot.example.com/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_returns_model_from_response(): void
    {
        ...
        $this->assertSame('moonshot-v1-8k', $response->model);
    }
