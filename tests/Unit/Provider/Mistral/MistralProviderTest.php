...
final class MistralProviderTest extends TestCase
{
    ...
    public function test_generate_calls_correct_url(): void
    {
        ...
        $provider = new MistralProvider($transport, 'test-api-key');
        ...
        $this->assertSame('https://api.mistral.ai/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_passes_model_in_body(): void
    {
        ...
        $this->assertSame('mistral-medium', $transport->capturedBody['model']);
    }
    ...
    public function test_get_name_returns_mistral(): void
    {
        $transport = $this->createMockTransport([]);
        $provider = new MistralProvider($transport, 'test-api-key');
    ...
    public function test_custom_base_url_is_used(): void
    {
        ...
        $provider = new MistralProvider(
            $transport,
            'test-api-key',
            'https://custom.mistral.example.com/v1',
        );
        ...
        $this->assertSame('https://custom.mistral.example.com/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_returns_model_from_response(): void
    {
        ...
        $this->assertSame('mistral-large-latest', $response->model);
    }
