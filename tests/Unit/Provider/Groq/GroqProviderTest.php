...
namespace HelgeSverre\Synapse\Tests\Unit\Provider\Groq;
...
final class GroqProviderTest extends TestCase
{
    ...
    public function test_generate_calls_correct_url(): void
    {
        ...
        $provider = new GroqProvider($transport, 'test-api-key');
        ...
        $this->assertSame('https://api.groq.com/openai/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_passes_model_in_body(): void
    {
        ...
        $this->assertSame('llama-3.1-8b-instant', $transport->capturedBody['model']);
    }
    ...
    public function test_get_name_returns_groq(): void
    {
        $transport = $this->createMockTransport([]);
        $provider = new GroqProvider($transport, 'test-api-key');

        $this->assertSame('groq', $provider->getName());
    }
    ...
    public function test_custom_base_url_is_used(): void
    {
        ...
        $provider = new GroqProvider(
            $transport,
            'test-api-key',
            'https://custom.groq.example.com/v1',
        );
        ...
        $this->assertSame('https://custom.groq.example.com/v1/chat/completions', $transport->capturedUrl);
    }
    ...
    public function test_generate_returns_model_from_response(): void
    {
        ...
        $this->assertSame('llama-3.1-70b-versatile', $response->model);
    }
