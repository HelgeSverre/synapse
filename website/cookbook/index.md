...
Practical patterns and recipes for common LLM tasks with Synapse.

## Patterns

| Pattern                                          | Description                                    |
| ------------------------------------------------ | ---------------------------------------------- |
| [Data Extraction](/cookbook/extraction)          | Extract structured data from unstructured text |
| [Classification](/cookbook/classification)       | Classify text into categories                  |
